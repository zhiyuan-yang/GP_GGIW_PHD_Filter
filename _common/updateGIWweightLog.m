...
% A.Reference: [1] K. Granstrom and U. Orguner, "A PHD Filter for Tracking Multiple 
% Extended Targets Using Random Matrices,” IEEE Transactions on Signal Processing.
...
logC = -gam+log(p_D)-(d/2)*log(Nm*det(S));
